...
export default function EditorFile() {
    ...
    async function load() {
        try {
            ...
            setExam(res.data);
            setCodes(Array(res.data.tasks.length).fill(""));
    ...
    async function finish() {
        ...
        try {
            await submitExam(id, user.uid, {
                name: user.name, email: user.email, codes: codes, createdAt: new Date().toISOString()
            });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0d1b2a] via-[#1b263b] to-[#415a77] flex items-center justify-center">
            <div className="flex flex-col items-center gap-8">
                ...
                {/* круг */}
                <div className="w-24 h-24 border-[8px] border-[#fca311] border-t-transparent rounded-full animate-spin"></div>
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155]">
        ...
        {message && (<div
            className="fixed top-6 right-6 z-[100] bg-[#0f172a] border border-green-500 px-8 py-4 rounded-2xl text-white shadow-2xl animate-pulse">
            {message}
        </div>)}
        ...
        <div className="max-w-7xl mx-auto p-10">
            ...
            <div className="grid md:grid-cols-2 gap-10">
                ...
                >
                    ...
                    <Editor
                        ...
                        options={{
                            readOnly: isSubmitted, minimap: {enabled: false}
                        }}
                    />
            ...
            <div className="fixed bottom-8 right-8 z-50">
                <button
                    ...
                    className={`
px-10 py-5 rounded-3xl font-black text-lg shadow-2xl
